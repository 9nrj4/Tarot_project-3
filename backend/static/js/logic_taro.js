    ...
    function showTarotCards() {
                ...
                data.cards.forEach((cardData, index) => {
                    ...
                    card.innerHTML = `
                        <div class="card-inner">
                            ...
                            <div class="card-back">
                                <img src="/api/static/images/tarot/${cardData.image}" alt="${cardData.name}" class="card-image">
        ...
        for (const card of selectedCards) {
            ...
            cardElement.innerHTML = `
                <img src="/api/static/images/tarot/${card.image}" alt="${card.name}" class="selected-card-image">
